...
class Config(object):
    ...
    def __init__(self, dataset, embedding):
        ...
        self.model_name = 'FastText_gp_ldia_300_sentiment'                         # 模型名称  
        ...
        self.embedding_pretrained_topics = torch.tensor(
            np.load(dataset + '/data/embedding_ldia.zh.300_sentiment.npz' )["embeddings"].astype('float32'))                              # 预训练词向量
        ...
        self.hidden_size = (self.embed*3+self.topics)*2                                        # 隐藏层大小
